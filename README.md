...
Flappy Anything is a charming game inspired by two iconic elements:

- The playful and customizable spirit of endless creativity, where players can choose any character and fly through any map.  
- Flappy Bird, the legendary Vietnamese mobile game developed by Nguyen Ha Dong in 2013.

The game was developed using SDL2 and C++, aiming to deliver a fun, nostalgic, and highly personalized experience.  

⏳ Built on the foundation of Do Thanh Dat's source code, this project was developed and improved over the course of a month. The modifications and enhancements transform the game into a versatile playground for imagination.  

Special thanks to the original author for their excellent codebase. This project is created to serve as a learning subject and is entirely non-commercial.
<br><br>
💡 TEAM: CÁ MẶP CẠP ĐẦU
...
<p align="center"><a href="https://github.com/TranDucLuong2201/CA-MAP-CAP-DAU.git"><img width="50%" src="assets/Blank diagram.png"></a></p>
